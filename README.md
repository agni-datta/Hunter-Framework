...
<li>A network mapper that shows MAC and IP addresses.</li>
...
<b>Note: <br>Make sure to run the framework in root user. Hunter requires some permissions, which are only available to the root user</b>  
...
<li>Now you may choose your option and hit enter, which would ask you input regarding the target, gateway,…etc</li>
